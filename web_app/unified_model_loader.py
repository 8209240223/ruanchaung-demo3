...
DEMO1_MODEL_PATH = os.path.join(BASE_DIR, '..', 'demo1', 'processed_dataset', 'best_model.pth')
DEMO2_MODEL_PATH = os.path.join(BASE_DIR, '..', 'demo2', 'processed_dataset', 'best_model.pth')
APPLE_DISEASE_MODEL_PATH = os.path.join(WEB_APP_DIR, 'apple', 'processed_dataset', 'best_model.pth')
APPLE_FRUIT_DISEASE_MODEL_PATH = os.path.join(WEB_APP_DIR, 'apple', 'fruit_processed_dataset', 'best_model.pth')
